  ...
  <form className={style.form} onSubmit={handleSubmit}>
    ...
    <div>
      <label htmlFor="">Report Name</label>
       <input type="text" name='reportTitle' value={formData?.reportTitle} onChange={handleInputChange}/>
    </div>
    <div>
      <label htmlFor="">Report Type</label>
      <input type="text" name='reportType' value={formData?.reportType} onChange={handleInputChange}/>
    </div>
    <div>
      <label htmlFor="">Date From</label>
      <input type="date" name='dateRangeFrom' value={formData?.dateRangeFrom} onChange={handleInputChange}/>
    </div>
    <div>
      <label htmlFor="">Date To</label>
      <input type="date" name='dateRangeTo' value={formData?.dateRangeTo?.slice(0,10)} onChange={handleInputChange}/>
    </div>
    <div>
      <label htmlFor="">Report Summary</label>
       <input type="number" name='report' value={formData?.report} onChange={handleInputChange}/>
    </div>
    <div>
