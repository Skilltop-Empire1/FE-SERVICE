    ...
    try {
        ...
        if (data?.inventoryId) {
            ...
            result = await editResource({
                url: `/inventory/edit/${data.inventoryId}`,
                method: 'PUT',
                data: inventoryData,
            }).unwrap();
...
useEffect(() => {
  ...
  <form className={style.form} onSubmit={handleSubmit}>
    ...
    <div>
      ...
      <input type="date" name='datePurchased' value={formData?.datePurchased} onChange={handleInputChange}/>
    </div>
    <div>
      <label htmlFor="">Total Value</label>
      <input type="text" name='totalValue' value={formData?.totalValue} onChange={handleInputChange}/>
    </div>
    <div >
